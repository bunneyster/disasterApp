...
module PushReceiver
  ...
  included do
    ...
    validates :push_url, length: { in: 1..128, allow_nil: true }

    # The receiver ID for pushing notifications to this device.
    validates :push_uid, length: { in: 1..256, allow_nil: true }
  end
  ...
  def push_message(data)
    ...
    request.body = { receiver: push_uid, message: data }.to_json
