...
(function() {
  ...
  W3gram._.DeviceRegistration = (function() {
    function DeviceRegistration(json) {
      ...
      this.apiKey = json.app;
      this.deviceId = json.device;
      ...
      this.serverUrl = serverUrl;
      this._routeUrl = serverUrl + "/route";
      return;
    }
    ...
    DeviceRegistration.prototype.push = function(message) {
      ...
      return W3gram._.jsonRequest('POST', this.pushUrl, pushOptions).then(function() {
        return true;
      });
    };
    ...
    DeviceRegistration.prototype.route = function() {
      ...
      return W3gram._.jsonRequest('POST', this._routeUrl, routeOptions).then(function(json) {
        return json.listen;
      });
    };
  ...
  (function() {
    var arrayToBase64, crypto, hmacSha256, requireError, sha256, sha256Init, sha256Key, stringToArray, _base64Digits;
  ...
  W3gram.PushRegistration = (function() {
    function PushRegistration(deviceRegistration, options) {
      ...
      this.registrationId = deviceRegistration.receiverId;
    ...
    PushRegistration.prototype.registrationId = null;
